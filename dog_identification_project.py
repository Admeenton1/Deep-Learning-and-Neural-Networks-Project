# -*- coding: utf-8 -*-
"""Dog-Identification-Project.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kZZxRuxEjCDt_lYsN5VS8qJ8RQL-Udqg
"""
...
This competition from Kaggle was executed using TensorFlow 2.x and TensorFlow Hub.
...
Data source: Kaggle's dog breed identification competition.
...
* We're dealing with images (unstructured data). Hence, deep learning/transfer learning is deployed.
* There are 120 breeds of dogs (that is 120 different classes).
...
print("GPU", "Great!! available..." if tf.config.list_physical_devices("GPU") else "not available :(")
...
import pandas as pd
labels_csv = pd.read_csv("/content/drive/MyDrive/Colab Notebooks/Dog Vision/dog-breed-identification.csv")
